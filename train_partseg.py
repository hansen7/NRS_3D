...
import os, sys, torch, datetime, logging, importlib, shutil, provider, argparse, numpy as np
...
def parse_args():
	...
	parser.add_argument('--epoch', default=251, type=int,
...
def main(args):
	...
	shutil.copy('nfl_config/pointnetnfl_partseg.yaml', str(experiment_dir))
	shutil.copy('nfl_config/pointnet2nfl_partseg_msg.yaml', str(experiment_dir))
