...
Download 3D indoor parsing dataset (S3DIS) and save in data/Stanford3dDataset_v1.2/.
 ...
 - `python gen_indoor3d_h5.py` to generate HDF5 files from saved .npy arrays
...
NUM_POINT = 4096  # number of points in each bounding box
H5_BATCH_SIZE = 1000  # number of instances saved in each hdf5 files
...
def insert_batch(data, label, last_batch=False):
	...
	if last_batch and buffer_size > 0:  # to save the last ones
		h5_filename = output_filename_prefix + '_' + str(h5_index) + '.h5'
