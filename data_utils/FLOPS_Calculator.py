...
if __name__ == "__main__":
	...
	model = get_model(num_class=40, nfl_cfg=Dict2Object(
		'../nfl_config/pointnetnfl_cls.yaml')).to(torch.device("cuda" if torch.cuda.is_available() else "cpu"))
	...
	def parse_args():
		...
		parser.add_argument('--nfl_cfg', type=str, default='../nfl_config/dgcnnnfl_cls.yaml', 
