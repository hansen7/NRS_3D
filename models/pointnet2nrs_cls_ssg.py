...
from NRS import NRS
from pointnet2_util import PointNetSetAbstraction
import pdb, torch.nn as nn, torch.nn.functional as F


class get_model(nn.Module):
	def __init__(self, num_class, nrs_cfg, normal_channel=True):
