...
class DGCNN(nn.Module):
	...
	def __init__(self, args, output_channels=40):
		...
		self.conv4 = nn.Sequential(nn.Conv2d(128*2, 256, kernel_size=1, bias=False), self.bn4,
								   nn.LeakyReLU(negative_slope=0.2))
		self.conv5 = nn.Sequential(nn.Conv1d(512, args.emb_dims, kernel_size=1, bias=False), self.bn5,
								   nn.LeakyReLU(negative_slope=0.2))
...
class DGCNN_NRS(nn.Module):
	def __init__(self, args, output_channels=40):
		super(DGCNN_NRS, self).__init__()
		self.args = args
		# Note that same types of batch normalisation still need to be declared multiple times
		self.bn1 = nn.BatchNorm2d(64)
		self.bn2 = nn.BatchNorm2d(64)
		self.bn3 = nn.BatchNorm2d(128)
		self.bn4 = nn.BatchNorm2d(256)
		...
		self.nrs = NRS(Dict2Object(args.nrs_cfg))
