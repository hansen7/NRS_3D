...
import os, torch, torch.nn as nn, torch.nn.parallel, torch.utils.data, torch.nn.functional as F
...
class get_model(nn.Module):
	def __init__(self, part_num=50, normal_channel=True,
				 cfg=Dict2Object(os.path.join(ROOT_DIR, 'pointnetnfl_partseg.yaml'))):
